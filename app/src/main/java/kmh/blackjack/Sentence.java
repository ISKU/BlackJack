...
public class Sentence {
	public static final String gameStart = "=*=*=*=*=*=*=*= Game Start =*=*=*=*=*=*=*=*=";
	public static final String gameEnd = "\n=*=*=*=*=*=*=* End Of Game *=*=*=*=*=*=*=*=\n";
	public static final String playAgain = "\nPlay Again? ";
	public static final String dealerBusted = "Dealer busted by going over 21.  You win.";
	...
	public static final String choiceHitOrStand = "Choose the Hit or Stand\n-> ";
	...
	public static final String userHit = "User hits.";
	public static final String userStand = "User stands.";
